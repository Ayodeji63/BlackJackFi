...
import { ChecboxInput, CheckboxInputWrapper, CheckboxLabel, ErrorMsg, Input, InputWrapper, Label } from "../ModalsManager.styled";
import { SocketEmit, SocketOn } from "../../../types.ds";
import { StyledBtn } from "../../App/App.styled";
import { error } from "console";
// import {game} from "../../../store/game"
// import {  } from "../../../server/socket";
...
export const EnterForm: React.FC = () => {
    ...
    //         id ? game.emit[SocketEmit.JoinTable](id, name, balance) : game.emit[SocketEmit.CreateTable](name, balance);
    //     },
    //     []
    // )
    ...
    //             JSON.parse(chat)
    //         );
    //         if (game.table && Gamepad.player) {
    //             navigate(`/table?id=${game.table.id}`);
    //         }

    //         game.modalUpdate(true);

    //         const soundSettings = game.music?.getLocaleSettings();
    //         if (soundSettings) {
    ...
    //         const tableIdInput = document.querySelector<HTMLInputElement>('input[name="tableId"]');
    //         if (tableIdInput) {
    //             tableIdInput.value = '';
    //         }
    //     };
